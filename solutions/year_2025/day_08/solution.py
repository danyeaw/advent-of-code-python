...
) -> tuple[list[set[tuple[int, ...]]], tuple[tuple[int, ...], tuple[int, ...]] | None]:
...
class Solution(StrSplitSolution):
    ...
    def part_1(self) -> int:
        ...
        strands, _ = connect_boxes(distances, max_pairs=1000)
    ...
    def part_2(self) -> int:
        boxes = self.parse_boxes()
        distances = calculate_distances(boxes)
        _, last_connection = connect_boxes(distances, stop_when_unified=True)
